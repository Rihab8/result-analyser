...
<div class="container">
<span class="text1">mechanical engineering</span>
...
<?php
	...
	$dbusername="root";
      ...
      else
      {
            ...
            $query="SELECT * FROM $table1 WHERE Sub1 NOT LIKE '' AND Sub2 NOT LIKE '' AND Sub3 NOT LIKE '' AND Sub4 NOT LIKE '' AND Sub5 NOT LIKE '' AND Sub6 NOT LIKE '' AND Sub7 NOT LIKE '' AND Sub8 NOT LIKE '' AND Sub9 NOT LIKE '' LIMIT 1";
